          ...
          <div className="col-md-6 offset-md-3">
            ...
            <div id="accordion">
              <div className="card">
                ...
                >
                  <div className="card-body">
                    We offer a wide range of high-quality grocery products,
              ...
              <div className="card">
                ...
                >
                  <div className="card-body">
                    To place an order, simply log in to our app, browse
                    products, and add them to your cart. Proceed to checkout to
                    complete your order.
                  </div>
                </div>
              </div>
